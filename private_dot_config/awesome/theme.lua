...
-- Pactl volume (not local, so that the keybinds work) 
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            volicon,
            --theme.volume.widget,
            volume_widget{widget_type = 'icon_and_text', tooltip = true},
            arrl_ld,
