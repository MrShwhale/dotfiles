...
local lockscreen_background = beautiful.lockscreen_background
...
local function create_images(s, lockbox_color)
	...
	profile_widget:connect_signal("button::release", function(self, lx, ly, button)
		...
		if button == 1 or button == 4 then
			...
			for s in screen do
				s.lockscreen.profile_widget.image =
					gears.surface.load_uncached(profile_image_used .. profile_images[profile_image_ind])
			end
